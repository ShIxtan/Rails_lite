...
describe Phase6::Route do
  ...
  describe "#matches?" do
    it "matches simple regular expression" do
      index_route = Phase6::Route.new("/users", :get, "x", :x)
      req.stub(:path) { "/users" }
    ...
    it "matches regular expression with capture" do
      index_route = Phase6::Route.new("/users/:id", :get, "x", :x)
    ...
    it "correctly doesn't matche regular expression with capture" do
      index_route = Phase6::Route.new("/users/:id", :get, "UsersController", :index)
  ...
  describe "#run" do
    ...
    it "instantiates controller and invokes action" do
      ...
      index_route = Phase6::Route.new("/users", :get, dummy_controller_class, :index)
...
describe Phase6::Router do
  ...
  describe "http method (get, put, post, delete)" do
    ...
    it "adds a route when an http method method is called" do
      router = Phase6::Router.new
      router.get "/users", Phase6::ControllerBase, :index
